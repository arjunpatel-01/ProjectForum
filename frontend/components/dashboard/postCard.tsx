            ...
            <ThemeProvider theme={themeView}>
                <div key={props.index} style={{paddingTop: "10px"}}>
                    <Card sx={{height: "400px"}}>
                        ...
                        <Grid container spacing={0} width={"100%"} height={"220px"} padding="0px 20px" >
                            ...
                            <Grid item container xs={5} alignItems="center">
                                ...
                                <Grid item xs={2}  sx={{textAlign: "right"}}>
                                    <>
                                        ...
                                        >
                                            <Grid container spacing={0} width={"100%"} padding="1%">
                                                <Grid item xs={12} sx={{textAlign: "right"}}>
                                                    {props.post.creator_id===userData.userId ? (
                                                        <>
                                                            <Tooltip title="Delete post">
                                            ...
                                            <Grid container spacing={0} width={"100%"} padding="0px 20px">
                                                <Grid item xs={12} zeroMinWidth height={"100%"} >
                                                    <Typography variant="h3" color="primary">
                                                        {props.post.title} 
                                                    </Typography>
                                            ...
                                            <Grid container spacing={0} width={"100%"} height={"50vh"} marginBottom={"20px"} padding="0px 20px" >
                                                <Grid item xs={12} zeroMinWidth height={"100%"} overflow="auto">
                                                    <Typography variant="body1" sx={{overflowWrap: "break-word", whiteSpace: "pre-line"}}>
                                                        {props.post.description}
                                                    </Typography>
                                                </Grid>
                                            ...
                                            <Grid container spacing={0} width={"100%"} height={"10vh"} padding="0px 20px">
                                                <Grid item xs={12}>
                                                    {props.post.is_started && (
                                                        <div style={{display: "flex", alignItems: "center"}}>
                                                            <GitHubIcon fontSize="small" sx={{color: "#6e5494"}}/>
                                            ...
                                            <Grid container spacing={0} width={"100%"} alignItems="center" padding="1% 10px">
                                                <Grid item xs={7}>
                                                    {props.post.is_completed ? (
                                                        props.post.creator_id === userData.userId ?
                                                        (
